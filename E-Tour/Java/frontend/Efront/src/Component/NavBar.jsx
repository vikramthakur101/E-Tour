...
function NavBarComponent() {
    ...
    const scrollToReviews = () => {
        if (location.pathname !== "/dashboard") {
            navigate("/dashboard"); // Navigate to the dashboard first
            setTimeout(() => {
                const element = document.getElementById("reviews");
                if (element) {
                    element.scrollIntoView({ behavior: "smooth" });
                }
            }, 500); // Small delay to ensure the dashboard component renders
        } else {
            const element = document.getElementById("reviews");
            if (element) {
                element.scrollIntoView({ behavior: "smooth" });
            ...
            >
                <Container>
                    ...
                    <Nav className="mx-auto d-flex gap-4">
                        ...
                        <Nav.Link onClick={scrollToReviews} className="text-white">
                            Reviews
                        </Nav.Link>
