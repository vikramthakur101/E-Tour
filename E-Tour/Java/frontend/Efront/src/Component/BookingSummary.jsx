...
import { Container, Card, Table, Row, Col, Button, ProgressBar, Alert } from "react-bootstrap";
import "bootstrap/dist/css/bootstrap.min.css";
import { useLocation, useNavigate } from "react-router-dom";
import { FaCheckCircle, FaUser, FaCalendarAlt, FaMoneyBillAlt } from "react-icons/fa";
import "./bookingsummary.css"; // Custom CSS for additional styling
...
const BookingSummary = () => {
    ...
    useEffect(() => {
        ...
        console.log("Passengers in local storage:", storedPassengers);
