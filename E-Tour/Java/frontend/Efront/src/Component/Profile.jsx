...
import { Container, Row, Col, Card, Tab, Tabs, Form,  ProgressBar, ListGroup } from 'react-bootstrap';
    ...
    return (
        <Container className="profile-page mt-5">
            <Row>
                ...
                <Col md={3} className="mb-4">
                    <Card className="profile-sidebar shadow-sm">
                        <Card.Body className="text-center">
                            ...
                            <h5 className="profile-name mb-1">{customer ? customer.firstName + " " + customer.lastName : "Loading..."}</h5>
                            <p className="profile-email text-muted mb-3">{customer ? customer.email : "Loading..."}</p>
                ...
                <Col md={9}>
                    <Tabs defaultActiveKey="personal-info" id="profile-tabs" className="mb-3">
                        {/* Personal Info Tab */}
                                ...
                                <Card.Body>
                                    ...
                                    <Form>
                                        <Row>
                                            <Col md={6}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <Form.Control type="text" value={customer?.firstName || ''} disabled />
                                                </Form.Group>
                                            </Col>
                                            <Col md={6}>
                                                <Form.Group className="mb-3">
                                                    <Form.Label>Last Name</Form.Label>
                                                    <Form.Control type="text" value={customer?.lastName || ''} disabled />
                                                </Form.Group>
                                            </Col>
                                        </Row>
                                        <Form.Group className="mb-3">
                                        ...
                                        {/* <Form.Group className="mb-3">
                                            ...
                                            <Form.Control type="tel" value={customer?.phoneNumber1 || ''} disabled />
                                        </Form.Group> */}
                                    </Form>
                                </Card.Body>
                            </Card>
